...
def evaluate(ys, snf, diffusion_model, INN, forward_model, out_dir, gt_path, n_samples_x=30000, n_repeats=10, epsilon = 1e-10, xlim = (-1.2,1.2),nbins = 75, figsize = (12,12), labelsize = 30):
...
if __name__ == '__main__':
    ...
    evaluate(y_test[:config['n_samples_y']],snf, diffusion_model, INN, forward_model, config['out_dir'], gt_dir, n_samples_x=config['n_samples_x'], n_repeats=2)
